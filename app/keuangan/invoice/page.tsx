...
import InvoiceModal from "./ModalTambahInvoice";
...
export default function InvoicePage() {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
            const response = await fetch(`/api/keuangan/invoice?page=${page}&limit=10&search=${search}`);
    ...
    const handleOpenModal = (invoice?: InvoiceWithDetails) => {
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-orange-600 mt-2">{unpaidInvoices}</h3>
                        </div>
